// PreToolUse hook (Bash matcher): the mn-skills loop prepares outward actions
  ...
  JSON.stringify({
    hookSpecificOutput: {
      ...
      permissionDecisionReason:
        'Outward action (push / PR / publish). The mn-skills loop stops here for explicit human confirmation — docs/development-workflow.md §5.',
    },
  }),
);
process.exit(0);
